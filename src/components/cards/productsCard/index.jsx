...
export function ProductsCard({ productList }) {

    return (
        <>
        {productList ? productList.map((product) => { //hver gang man bruker map, så skal du ha key på øverste element i map func
          return (
              <div key={product.id} className="flex flex-col items-center object-contain cursor-default w-36 my-2 mx-0.5 rounded-sm md:w-56 md:my-4 md:mx-2 lg:w-72 lg:my-6 lg:mx-4x lg:rounded-lg">
